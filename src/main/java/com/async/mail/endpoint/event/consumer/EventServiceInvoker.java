package com.async.mail.endpoint.event.consumer;

import com.async.mail.PojaGenerated;
import com.async.mail.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("com.async.mail.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "com.async.mail.service.event."
