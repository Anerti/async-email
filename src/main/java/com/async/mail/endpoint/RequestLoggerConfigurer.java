package com.async.mail.endpoint;

import static com.async.mail.concurrency.ThreadRenamer.renameFrontalThread;
import static com.async.mail.concurrency.ThreadRenamer.renameThread;
  ...
  private static class RequestLogger implements HandlerInterceptor {
    ...
    public boolean preHandle(
      ...
      try {
        ...
        parameters = "N/A";
        log.warn("Failed to read request parameters: {}", e.getMessage());
      }
      log.info(
