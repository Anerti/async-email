package com.async.mail.handler;

import static com.async.mail.concurrency.ThreadRenamer.renameWorkerThread;
...
import com.async.mail.PojaApplication;
import com.async.mail.PojaGenerated;
import com.async.mail.endpoint.EndpointConf;
import com.async.mail.endpoint.event.EventConf;
import com.async.mail.endpoint.event.consumer.EventConsumer;
import com.async.mail.endpoint.event.consumer.model.ConsumableEvent;
import com.async.mail.endpoint.event.consumer.model.ConsumableEventTyper;
